...
export const LOCATIONS: LocationConfig[] = [
  ...
  },
  {
    ...
    waves: [
      ...
      { count: 18, weights: { bat: 3, skeleton: 4, vampire: 2 }, hpMultiplier: 1.8 },
      { count: 16, weights: { skeleton: 4, vampire: 3, elite: 1 }, hpMultiplier: 2.0 },
      { count: 20, weights: { bat: 3, skeleton: 3, vampire: 4 }, hpMultiplier: 2.2 },
      { count: 8, weights: { skeleton: 3, vampire: 3, elite: 1 }, hpMultiplier: 2.5, boss: true },
    ],
  },
  {
    id: 'frozen-crypt',
    ...
    waves: [
      ...
      { count: 16, weights: { skeleton: 4, skeleton2: 2, vampire: 2 }, hpMultiplier: 2.2 },
      { count: 18, weights: { skeleton: 3, skeleton2: 3, vampire: 3 }, hpMultiplier: 2.4 },
      { count: 20, weights: { skeleton2: 4, vampire: 3, elite: 2 }, hpMultiplier: 2.7 },
      { count: 22, weights: { skeleton: 3, skeleton2: 4, vampire: 3 }, hpMultiplier: 3.0 },
      { count: 22, weights: { skeleton2: 5, vampire: 3, elite: 2 }, hpMultiplier: 3.3 },
      { count: 24, weights: { skeleton2: 4, vampire: 5 }, hpMultiplier: 3.6 },
      { count: 24, weights: { skeleton2: 5, vampire: 4, elite: 3 }, hpMultiplier: 4.0 },
      { count: 10, weights: { skeleton2: 4, vampire: 4, elite: 3 }, hpMultiplier: 4.5, boss: true },
    ],
  },
  {
    id: 'enchanted-forest',
